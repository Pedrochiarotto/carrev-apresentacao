...
export class App {
  readonly slides = [{"title": "CarRev", "category": "Contexto"}, {"title": "Apresentação", "category": "Contexto"}, {"title": "Business Model Canvas", "category": "Estratégia"}, {"title": "Persona", "category": "Estratégia"}, {"title": "Mapa de Empatia", "category": "Estratégia"}, {"title": "Diretrizes Estratégicas", "category": "Estratégia"}, {"title": "PESTEL", "category": "Análise"}, {"title": "5 Forças de Porter", "category": "Análise"}, {"title": "SWOT", "category": "Análise"}, {"title": "Matriz BCG", "category": "Conclusão"}];
  ...
  private readHash(): number {
    ...
    return match ? Math.min(9, Math.max(0, Number(match[1]) - 1)) : 0;
  }
